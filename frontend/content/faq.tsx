		...
		answer: (
			<>
				<p>
					...
					Vermächtnisses tun. Mit Hilfe eines Vermächtnisses können Sie einen ganz bestimmten Teil Ihres
					Nachlassvermögens zuwenden; zum Beispiel eine gewisse Summe an Bargeld, ein Sparkonto, Wertpapiere, ein
					Kunstwerk oder eine Immobilie.
				</p>
			</>
		),
	},
