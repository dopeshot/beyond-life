...
const Marriage = () => {
    ...
    const validationSchema: ObjectSchema<Marriage> = object().shape({
        relationshipStatus: mixed<RelationshipStatus>().required('Dieses Feld ist erforderlich. Bitte wählen Sie eine Option aus.'),
    })
                    ...
                    <Form>
                        ...
                        <div className="mb-5 lg:my-10">
                            <Label
                                ...
                                inputRequired
                            />
                            <div className="mb-2 grid grid-cols-4 gap-3 w-2/3">
