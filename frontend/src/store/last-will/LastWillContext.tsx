...
import { addOrganisationAction, addPersonAction, deleteOrganisationAction, deletePersonAction, updateOrganisationAction, updatePersonAction } from './heirs/actions'
