        ...
        <div className="mb-4">
            ...
            <Field name={name}>{(props: FieldProps<any>) => (
                <div data-cy={`${name}-clickdiv`} onClick={() => props.form.setFieldValue(name, !props.field.value)} className="inline-flex items-center cursor-pointer">
                    <div className={`w-14 h-7 flex items-center ${props.field.value ? "bg-yellow-500" : "bg-gray-300"} rounded-full p-1 duration-300 ease-in-out my-1 ${props.field.value ? "bg-primary-blue" : ""}`}>
