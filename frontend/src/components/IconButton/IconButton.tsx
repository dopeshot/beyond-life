...
export const IconButton: React.FC<IconButtonProps> = ({
	...
	const classes = `text-center ${disabled ? 'cursor-default' : `cursor-pointer ${backgroundColor ? `bg-${backgroundColor}-500 hover:bg-${backgroundColor}-600 focus:bg-${backgroundColor}-700` : `hover:bg-${color}-500 hover:bg-opacity-10 focus:bg-opacity-20`}`
