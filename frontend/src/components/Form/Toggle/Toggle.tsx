        ...
        <div className="mb-4">
            ...
            <Field name={name}>
                {(props: FieldProps<boolean>) => (
                    ...
                    >
                        <div
                            className={`flex h-7 w-14 items-center ${props.field.value ? 'bg-yellow-500' : 'bg-gray-300'
                                } my-1 rounded-full p-1 duration-300 ease-in-out`}
                        >
                            <div
                                datacy={`${name}-ball`}
                                className={`h-5 w-5 transform rounded-full bg-white shadow-md duration-300 ease-in-out ${props.field.value ? 'translate-x-7' : ''
                                    }`}
                            ></div>
                        </div>
