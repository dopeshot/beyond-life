                    ...
                    <div className="relative my-1 flex flex-col justify-center gap-1">
                        ...
                        <div className={`flex items-center`}>
                            <input
                                ...
                                {...fieldProps.field}
                                {...props}
                                className={`flex w-full items-center rounded-lg border bg-gray-200 p-2 px-4 ${icon && 'pr-12'} ${fieldProps.meta.touched && fieldProps.meta.error ? 'border-red-500 bg-red-50' : ''
                                    }`}
                            />
                            {icon && (
                                <div className={'w-0'}>
