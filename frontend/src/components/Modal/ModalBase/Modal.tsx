...
export const Modal: React.FC<ModalProps> = ({ open, onClose, headline, children }) => {
	...
	return (
		<dialog datacy="modal" className="rounded-lg" ref={modalRef} onClick={onClick} onClose={onClose}>
			<div className="px-3 pb-2 pt-1 md:px-6 md:pb-4 md:pt-2">
				<div className="flex items-center justify-between">
					...
					<IconButton datacy="modal-close" icon="close" onClick={onClose} className="-mr-3" />
				</div>
				{children}
			</div>
		</dialog>
